                                ...
                                HStack {
                                    ForEach(SelectPart.allCases, id: \.self) { item in
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(selectPart == item ? Color.gray : Color.white, lineWidth: 1)
                                            .background(selectPart == item ? Color.famous : Color.clear)
                                            .cornerRadius(12)
                                            ...
                                            .onTapGesture {
                                                store.send(.selectPartButton(selectPart: selectPart))
                                            }
                                            .id(item)
                                    }
                                }
